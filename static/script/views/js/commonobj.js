define(function(require){
	return commonObj = {
           ...
           var  showlength=5;
            ...
            for (var i = 0; i < showlength; i++) {              
                html += '<li><a href="#">'+
                    ...
                    '<span class="shuxing" data_url="productinfo.html">涓撳睘</span>'+
                    '<div class="leftimages fl"><canvas data-src="images/product/product1.png" ></canvas></div>'+
                     '<div class="productcontent fr">'+
                         '<p class="ptitle pl10">骞胯仈杈惧彉鏇寸畻閲?</p>'+
                          '<p class="pdes pl10">绠?浠嬭繖閲岀畝浠嬭繖閲岀畝浠嬭繖閲岀畝浠嬭繖閲岀畝浠嬭繖閲岀畝浠嬭繖閲岀畝浠嬭繖閲岀畝浠嬩粙杩欓噷绠?浠?</p>'+
                          '<p class="pprice pl10">浠锋牸锛?<span class="green">锟?5000</span></p>'+
                    '</div></a></li>';
            }
            $mainDiv.append(html);
        },
        ...
        addAddresslist:function(){
            ...
            /*var addresslist=$("#addresslist li").find(".phone").text();
            var addlist=[];
            var len=addresslist.length/11;
            for(var i=0;i<len;i++){
                addlist[i]=addresslist.substring(i*10+i,i*10+11+i);
            }
            if($.isArray(phone,addlist)){
                var allAddress=$(".phone").text();
            }*/
